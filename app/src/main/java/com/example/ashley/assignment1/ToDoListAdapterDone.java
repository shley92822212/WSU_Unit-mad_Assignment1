...
public class ToDoListAdapterDone extends ArrayAdapter<ToDoListClass> {
        private android.content.Context Context;
        private List<ToDoListClass> ToDoList = new ArrayList<>();

        public ToDoListAdapterDone(@NonNull Context context, ArrayList<ToDoListClass> list) {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        select.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                intent.putExtra("ToDoTitle", currentToDo.getTitle());
