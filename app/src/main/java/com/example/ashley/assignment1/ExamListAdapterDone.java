...
public class ExamListAdapterDone extends ArrayAdapter<ExamListClass> {
        private android.content.Context Context;
        private List<ExamListClass> ExamList = new ArrayList<>();

        public ExamListAdapterDone(@NonNull Context context, ArrayList<ExamListClass> list, Integer studentId) {
